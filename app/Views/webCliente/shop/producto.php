                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="product-gallery">
                            <div class="quickview-slider-active owl-carousel owl-theme owl-hidden owl-loaded">
                                ...
                                <div class="owl-stage-outer">
                                    <div class="owl-stage" style="transform: translate3d(-1650px, 0px, 0px); transition: all 0.4s ease 0s; width: 4400px;">
                                        <div class="owl-item cloned" style="width: 550px; margin-right: 0px;">
                                            <div class="single-slider">
                                                <img src="http://wpthemesgrid.com/themes/eshop/images/modal3.png" alt="#">
                                            </div>
                                        </div>
                                        <div class="owl-item cloned" style="width: 550px; margin-right: 0px;">
                                            <div class="single-slider">
                                                <img src="http://wpthemesgrid.com/themes/eshop/images/modal4.png" alt="#">
                                            </div>
                                        </div>
                                        <div class="owl-item" style="width: 550px; margin-right: 0px;">
                                            <div class="single-slider">
                                                <img src="http://wpthemesgrid.com/themes/eshop/images/modal1.png" alt="#">
                                            </div>
                                        </div>
                                        <div class="owl-item active" style="width: 550px; margin-right: 0px;">
                                            <div class="single-slider">
                                                <img src="http://wpthemesgrid.com/themes/eshop/images/modal2.png" alt="#">
                                            </div>
                                        </div>
                                        <div class="owl-item" style="width: 550px; margin-right: 0px;">
                                            <div class="single-slider">
                            ...
                            <div class="size">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="nice-select" tabindex="0"><span class="current">orange</span>
                                            <ul class="list">
                                                <li data-value="orange" class="option selected">orange</li>
                                                <li data-value="purple" class="option">purple</li>

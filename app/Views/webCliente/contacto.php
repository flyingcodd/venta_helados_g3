                ...
                <div class="col-lg-4 col-12">
                    <div class="single-head">
                        <div class="single-info">
                            ...
                            <ul>
                                <li>+51 927 61 35 80</li>
                                <li>+51 983 659 999</li>
                            </ul>
                        </div>
                        <div class="single-info">
                            ...
                            <ul>
                                <li><a href="jaimecarrascotaipe@gmail.com">jaimecarrascotaipe@gmail.com</a></li>
                                <li><a href="heladeria_ice_cream@gmail.com">heladeria_ice_cream@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="single-info">
                            ...
                            <ul>
                                <li>Av. Garcilazo con Huancavelica N.123</li>
                            </ul>
                        </div>
                    </div>
                </div>
